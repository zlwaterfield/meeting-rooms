...
import com.example.otppmeetingrooms.DbHelper;
import com.example.otppmeetingrooms.NewUserActivity;
import com.example.otppmeetingrooms.R;
import com.example.otppmeetingrooms.UserLoggedInPage;
import com.example.otppmeetingrooms.R.id;
import com.example.otppmeetingrooms.R.layout;
		...
		case R.id.buttonLogin:
			...
			if(uname.equals("") || uname == null){
				...
				if(validLogin){
					...
					Intent i = new Intent(DatabaseActivity.this, MainActivity2.class);
					startActivity(i);
					finish();
				}
			}
